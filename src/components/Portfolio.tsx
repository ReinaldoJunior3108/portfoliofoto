        ...
        <div className="h-dvh">
            <div className="flex flex-col justify-evenly h-full">
                ...
                <div className="font-[Montserrat] flex justify-evenly items-center text-white h-[60dvh]">
                    <div className="bg-[url(https://ik.imagekit.io/pagnofotografia/IMG_9446.jpg)] relative bg-cover w-[25%] h-full flex items-center justify-center rounded-[30px] shadow-[3px_6px_15px_rgba(255,255,255,0.2),inset_6px_4px_6px_0px_rgba(255,_255,_255,_0.1)] ">
                    ...
                    <div className="bg-[url(https://ik.imagekit.io/pagnofotografia/IMG_0382-1.jpg)] relative bg-cover w-[25%] h-full flex items-center justify-center rounded-[30px] shadow-[3px_6px_15px_rgba(255,255,255,0.2),inset_6px_4px_6px_0px_rgba(255,_255,_255,_0.1)] ">
                    ...
                    <div className="bg-[url(https://ik.imagekit.io/pagnofotografia/IMG_0018-6.jpg)] relative bg-cover w-[25%] h-full flex items-center justify-center rounded-[30px] shadow-[3px_6px_15px_rgba(255,255,255,0.2),inset_6px_4px_6px_0px_rgba(255,_255,_255,_0.1)] ">
